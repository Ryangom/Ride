...
// Get Method
  ...
  Future<dynamic> get(String url) async {
    ...
    var header = {'Authorization': 'Bearer akjdka', 'Content-Type': 'application/json'};
...
//Post method
  Future<dynamic> post(String url, dynamic payload) async {
    ...
    var header = {'Authorization': 'Bearer sdfsdf', 'Content-Type': 'application/json'};
  ...
  Future<dynamic> postWithQueryParams(
      String url, Map<String, dynamic> data, Map<String, dynamic> queryParams) async {
