...
import 'package:ride_user/Pages/authPages/forgetOtp.page.dart';
...
class _SignForgetPassState extends State<ForgetPassPage> {
  ...
  void submit() async {
    ...
    var response = await NetworkProvider()
        .post('/auth/forgotPassword', {'mobileNumber': mobile});
    var data = jsonDecode(response);
    if (data['status'] == 'success') {
      Navigator.push(context, MaterialPageRoute(builder: (context) {
        return ForgetOtp(mobileNumber: mobile, email: data['userEmail']);
      }));
    } else {
